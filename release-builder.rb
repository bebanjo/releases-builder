...
releases.each do |release|
  ...
  if counts['+1'] > 0
    ...
    commit(client, repo, ref, branch, "Implements ##{release[:number]}", content)
    pr(client, repo, ref, branch, "Release note: #{get_title(release[:body])}", "Implements ##{release[:number]}. This PR was autogenerated.")
  end
end
